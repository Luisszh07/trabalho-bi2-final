...
- **KR1:** Identificar os 100 municípios com menor Gasto Público Per Capita e cruzar com seu IDHM até a entrega do projeto. (KPI 1)
...
- **KR2:** Verificar se pelo menos 70% dos municípios com IDH abaixo de 0,60 têm participação do setor público abaixo de 40% do valor adicionado total. (KPI 4)
- **KR3:** Calcular a correlação entre PIB Per Capita e IDH para todas as regiões e apresentar no dashboard. (KPI 5 e KPI 2)
